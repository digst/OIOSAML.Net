...
namespace dk.nita.test.Saml20
{
    ...
    public class Saml20CoreValidationTest
    {
        ...
        public void _0001_NameID_Invalid_EmptyEmail()
        {
            ...
            Assert.Throws<Saml20FormatException>(
        ...
        public void _0002_NameID_Invalid_EmptyX509SubjecName()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with X509SubjectName Format attribute MUST contain a Value that contains more than whitespace characters");
        }
        ...
        public void _0002_NameID_Invalid_WindowsDomainQualifiedName_Whitespace()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with Windows Format attribute MUST contain a Value that contains more than whitespace characters");
        }
        ...
        public void _0002_NameID_Invalid_KerberosEmpty()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with Kerberos Format attribute MUST contain a Value that contains more than whitespace characters");
        }
        ...
        public void _0002_NameID_Invalid_Entity_Empty()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with Entity Format attribute MUST contain a Value that contains more than whitespace characters");
        }
        ...
        public void _0002_NameID_Invalid_Persistent_Empty()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with Persistent Format attribute MUST contain a Value that contains more than whitespace characters");
        }
        ...
        public void _0002_NameID_Invalid_Transient_MinLength()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateNameID(nameID),
                "NameID with Transient Format attribute MUST have a Value with at least 16 characters (the equivalent of 128 bits)");
        }
        ...
        public void WrongVersion()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => CreateSaml20Token(saml20Assertion),
                "Wrong value of version attribute on Assertion element");
        }
        ...
        public void IssuerFormat()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => CreateSaml20Token(saml20Assertion),
                "NameID element has Format attribute which is not a wellformed absolute uri.");
        }
        ...
        public void OneTimeUse()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Assertion contained more than one condition of type OneTimeUse");
        }
        ...
        public void ProxyRestriction()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Assertion contained more than one condition of type ProxyRestriction");
        }
        ...
        public void ProxyRestriction_Invalid_Count()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Count attribute of ProxyRestriction MUST BE a non-negative integer");
        }
        ...
        public void ProxyRestriction_Invalid_Audience()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "ProxyRestriction Audience MUST BE a wellformed uri");
        }
        ...
        public void TimeRestriction_NotBefore_Invalid()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                ...
                "Conditions.NotBefore is not within expected range");
        }
        ...
        public void TimeRestriction_NotOnOrAfter_Invalid_Yesterday()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateTimeRestrictions(saml20Assertion, new TimeSpan(), DateTime.UtcNow),
                "Conditions.NotOnOrAfter is not within expected range");
        }
        ...
        public void AudienceRestriction_Invalid_NoConfiguration()
        {
            ...
            try
            {
                ...
                Assert.Throws<Saml20FormatException>(
                    () => CreateSaml20Token(saml20Assertion),
                    "The service is not configured to meet any audience restrictions");
            }
            finally
            {
        ...
        public void AudienceRestriction_Invalid_Assertion()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => CreateSaml20Token(saml20Assertion),
                "Audience element has value which is not a wellformed absolute uri");
        }
        ...
        public void SubjectConfirmationData_Invalid_KeyInfoConfirmationData_NoAnyElement()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateSubjectConfirmationData(subjectConfirmationData),
                "SubjectConfirmationData element MUST have at least one " + KeyInfo.ELEMENT_NAME + " subelement");
        }
        ...
        public void SubjectConfirmationData_Invalid_KeyInfoConfirmationData_IncompleteAnyElement()
        {
            ...
            Assert.Throws<Saml20FormatException>(
                () => validator.ValidateSubjectConfirmationData(subjectConfirmationData),
                "SubjectConfirmationData element MUST contain at least one " + KeyInfo.ELEMENT_NAME + " in namespace " + Saml20Constants.XMLDSIG);
        }
