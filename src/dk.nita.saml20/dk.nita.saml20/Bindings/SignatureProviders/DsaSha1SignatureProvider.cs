...
{
    internal class DsaSha1SignatureProvider : SignatureProvider
    {
        public override string SignatureUri => SignedXml.XmlDsigDSAUrl;
        public override string DigestUri => SignedXml.XmlDsigDSAUrl;
